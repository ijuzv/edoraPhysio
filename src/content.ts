    ...
    .map(
      ([n, title, desc, id]) => {
        const imageMap: Record<string, string> = {
          'musculoskeletal': 'photos/care-musculoskeletal.jpg',
          'rehabilitation': 'photos/care-rehabilitation.jpg',
          'movement': 'photos/care-movement.jpg',
          'online': 'photos/care-online.jpg',
        };
...
add(
  ...
  `${intro(
    ...
    'care-pain.jpg',
    'Hands-on physiotherapy for the back during a pain management session',
    ...
    'care-conditions.jpg',
    'Physiotherapist explaining spinal anatomy during a conditions consultation',
    ...
    'care-injury-rehab.jpg',
    'Guided step and resistance-band work during injury rehabilitation',
    ...
    'care-movement-strength.jpg',
    'Physiotherapist guiding a kettlebell squat for movement and strength',
...
add(
  '/privacy/',
  'Privacy Policy',
  'How Eudora Movement House collects, uses and protects personal information from consultation requests.',
  `${intro(
    'Privacy Policy',
    'Your information.<br><em>Handled thoughtfully.</em>',
    'Eudora Movement House respects your privacy and is committed to handling your personal information responsibly.',
  )}<article class="wrap section prose"><h2>Information we collect</h2><p>When you request a consultation, we may collect:</p><ul><li>Name</li><li>Age</li><li>Phone number</li><li>General location</li><li>Preferred mode of care—home visit or online consultation</li><li>Preferred date and time</li><li>Any information you voluntarily share while communicating with us</li></ul><p>More detailed health or medical information may be requested separately when required for assessment and treatment.</p><h2>How we use your information</h2><p>Your information may be used to:</p><ul><li>Review and respond to your consultation request</li><li>Contact you regarding appointment availability</li><li>Arrange an online consultation or home visit</li><li>Provide physiotherapy-related services</li><li>Maintain appropriate clinical and administrative records</li><li>Communicate relevant appointment or follow-up information</li><li>Meet applicable professional, legal and regulatory requirements</li></ul><p>Providing your preferred date and time does not automatically confirm an appointment. Confirmation will be communicated separately.</p><h2>Location information</h2><p>For home visits, your general location helps us check service availability. Your complete address may be requested after the appointment has been accepted. Location information will not be displayed publicly.</p><h2>Sharing and protection of information</h2><p>We do not sell or rent your personal information. Information may be shared only with professionals or service providers involved in delivering or supporting your care, where reasonably necessary, or when required by law.</p><p>Reasonable measures are used to protect your information. However, no website, email, messaging platform or electronic storage system can guarantee complete security.</p><h2>Your choices and rights</h2><p>You may contact us to request access to, correction of or deletion of your personal information, subject to applicable legal and clinical record-retention requirements. You may also withdraw consent for future communication.</p><p>Withdrawing consent will not affect information already processed lawfully and may limit our ability to arrange or provide services.</p><h2>Children’s information</h2><p>For individuals below 18 years of age, the consultation request should be submitted or authorised by a parent or legal guardian.</p><h2>Contact</h2><p>For privacy-related questions or requests, contact:</p><p>Eudora Movement House<br>Email: <a href="mailto:${email}">${email}</a></p><p>This Privacy Policy may be updated when our services, systems or legal obligations change.</p></article>`,
  { ctaShow: false },
);
...
add(
  '/terms/',
  'Terms of Service',
  'Terms for requesting and using physiotherapy consultations with Eudora Movement House.',
  `${intro(
    'Terms of Service',
    'A clear<br><em>starting point.</em>',
    'By submitting a consultation request or using the services of Eudora Movement House, you agree to the following terms.',
  )}<article class="wrap section prose"><h2>Consultation requests</h2><p>Submitting the booking form does not create a confirmed appointment. Eudora Movement House will contact you to confirm availability, mode of care, appointment time, applicable charges and any further requirements.</p><h2>Accuracy of information</h2><p>You agree to provide accurate and complete personal, health and contact information. Please inform the physiotherapist about relevant medical conditions, medications, surgeries, pregnancy, allergies, recent injuries or changes in symptoms before assessment or treatment.</p><h2>Physiotherapy services</h2><p>Recommendations and treatment are based on the information available and the findings of the physiotherapy assessment. Outcomes vary between individuals, and no specific result or complete recovery can be guaranteed.</p><p>A consultation does not replace emergency medical care or specialist medical evaluation when these are required.</p><h2>Online consultations</h2><p>Online physiotherapy may include discussion, observation, movement assessment, exercise guidance, self-management strategies and progress review.</p><p>Some physical examinations and hands-on procedures cannot be performed remotely. An in-person assessment or medical consultation may therefore be recommended when appropriate.</p><p>You are responsible for participating from a safe environment, following instructions within your comfort and informing the physiotherapist immediately if you experience pain, dizziness, breathlessness or any unusual symptoms.</p><h2>Home visits</h2><p>Home visits are subject to location, travel feasibility, practitioner availability and confirmation. The patient is responsible for providing a reasonably safe, private and suitable space for assessment and treatment.</p><h2>Emergencies</h2><p>Eudora Movement House is not an emergency service. For severe or sudden symptoms—including chest pain, breathing difficulty, loss of consciousness, sudden weakness, suspected stroke symptoms, major trauma or rapidly worsening symptoms—please contact local emergency medical services or visit the nearest hospital immediately.</p><h2>Fees, cancellations and rescheduling</h2><p>Consultation fees and payment requirements will be communicated before confirmation. Cancellation, rescheduling or refund conditions, where applicable, will be shared at the time of booking.</p><h2>Right to modify or decline services</h2><p>A consultation may be modified, postponed or declined when physiotherapy is considered unsuitable, when medical clearance is required, when necessary information has not been provided or when safe service delivery is not reasonably possible.</p><h2>Changes to these terms</h2><p>These terms may be updated when our services or applicable requirements change. The version displayed on the website at the time of use will apply.</p></article>`,
  { ctaShow: false },
);
